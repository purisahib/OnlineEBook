...
public class DownloadEleven {
    private static final String TAG = "Download Task";
    private Context context;
    private Button buttonText;
    private String downloadUrl = "", downloadFileName = "";

    public DownloadEleven(Context context, Button buttonText, String downloadUrl) {
        this.context = context;
        this.buttonText = buttonText;
        this.downloadUrl = downloadUrl.replace(" ", "%20");
        downloadFileName = downloadUrl.replace(UtilsSchool.mainUrlel, "");//Create file name by picking download file name from URL
