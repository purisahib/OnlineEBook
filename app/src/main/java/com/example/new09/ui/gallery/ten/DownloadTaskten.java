...
class DownloadTaskten {
    private static final String TAG = "Download Task";
    private Context context;
    private Button buttonText;
    private String downloadUrl = "", downloadFileName = "";

    public DownloadTaskten(Context context, Button buttonText, String downloadUrl) {
        this.context = context;
        this.buttonText = buttonText;
        this.downloadUrl = downloadUrl.replace(" ", "%20");
        downloadFileName = downloadUrl.replace(UtilsSchool.mainUrlt, "");//Create file name by picking download file name from URL
