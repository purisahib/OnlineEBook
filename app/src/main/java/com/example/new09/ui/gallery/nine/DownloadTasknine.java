...
import com.example.new09.ui.gallery.CheckForSDCard;
 ...
 */
public class DownloadTasknine {
    private static final String TAG = "Download Task";
    private Context context;
    private Button buttonText;
    private String downloadUrl = "", downloadFileName = "";

    public DownloadTasknine(Context context, Button buttonText, String downloadUrl) {
        this.context = context;
        this.buttonText = buttonText;
        this.downloadUrl = downloadUrl.replace(" ", "%20");
        downloadFileName = downloadUrl.replace(UtilsSchool.mainUrln, "");//Create file name by picking download file name from URL
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/"+ UtilsSchool.downloadDirectoryn);
                } else
